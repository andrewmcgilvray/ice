    ...
    <div ng-show="!graphOnly()" class="meta">
      <div class="metaStart">
        ...
        <div ng-show="usage_cost=='cost'" class="metaCostType">
          ...
          <div><input type="checkbox" ng-model="costType['Allocated']" ng-change="costTypesChanged()"> Allocated</div>
          <div><input type="checkbox" ng-model="costType['Tax']" ng-change="costTypesChanged()"> Tax</div>
          <div><input type="checkbox" ng-model="costType['Amortization']" ng-change="costTypesChanged()"> Amortization</div>
          <div><input type="checkbox" ng-model="costType['Refund']" ng-change="costTypesChanged()"> Refund</div>
          <div><input type="checkbox" ng-model="costType['Subscription']" ng-change="costTypesChanged()"> Subscription</div>
