...
<body>
  <div class="" style="margin: auto; width: 1600px; padding: 20px 30px" ng-controller="reservationCtrl">
    <div ng-show="!graphOnly()" class="meta">
      ...
      <div class="metaRegions" ng-show="1-showZones">
      ...
      <div class="metaZones" ng-show="showZones">
        <input type="checkbox" ng-model="dimensions[ZONE_INDEX]" ng-change="zonesEnabled()"> Zone
          ...
          <div>
            ...
            <div ng-show="enabledUserTags[${index}]" class="metaTag">
              <select ng-model="selected_userTagValues[${index}]"
                      ...
                      multiple="multiple" class="metaUserTags metaSelect">
              </select>
              <br>
