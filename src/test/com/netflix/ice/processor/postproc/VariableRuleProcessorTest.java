...
public class VariableRuleProcessorTest {
	...
	public void testGenerateAllocationReportWithUsageType() throws Exception {
        ...
        TagGroupSpec[] dataSpecs = new TagGroupSpec[]{
        		new TagGroupSpec(DataType.cost, a1, "us-west-2", "us-west-2b", ec2Instance, "RunInstances", "r5.4xlarge", new String[]{"cluster", "", "", "", "", "", ""}, 40.0),
        		new TagGroupSpec(DataType.cost, a1, "us-west-2", "us-west-2a", ec2Instance, "RunInstances", "p3.2xlarge", new String[]{"cluster", "", "", "", "", "", ""}, 40.0),
        		
        		new TagGroupSpec(DataType.cost, a1, "us-west-2", "us-west-2b", ebs, "CreateVolume-Gp2", "EBS:VolumeUsage.gp2", new String[]{"cluster", "", "", "", "", "", ""}, 8.0),
        		
        		new TagGroupSpec(DataType.cost, a1, "us-west-2", "us-west-2b", cloudWatch, "MetricStorage:AWS/EC2", "CW:MetricMonitorUsage", new String[]{"cluster", "", "", "", "", "", ""}, 1.0),
        		
        		new TagGroupSpec(DataType.cost, a1, "us-west-2", "us-west-2b", dataTransfer, "InterZone-In", "DataTransfer-Regional-Bytes", new String[]{"cluster", "", "", "", "", "", ""}, 1.0),
        		new TagGroupSpec(DataType.cost, a1, "us-west-2", "us-west-2b", dataTransfer, "InterZone-Out", "DataTransfer-Regional-Bytes", new String[]{"cluster", "", "", "", "", "", ""}, 2.0),
        };
		CostAndUsageData data = new CostAndUsageData(0, null, rs.getUserTagKeys(), null, as, ps);
