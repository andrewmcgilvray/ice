...
public class CostAndUsageLineItemProcessorTest {
    ...
    @Test
    public void testRIFeeNoUpfrontRefund() throws Exception {
        Line line = new Line(LineItemType.Refund, "us-west-2", "", "AmazonEC2", "USW2-HeavyUsage:c5.large", "", "Discount", PricingTerm.reserved, "2021-01-01T00:00:00Z", "2021-02-01T00:00:00Z", "0", "-100.00", "No Upfront");
        line.setProductCode("AmazonEC2");
    ...
    @Test
    public void testSavingsPlanRecurringFeeRefund() throws Exception {
        // Test No Upfront
        Line line = new Line(LineItemType.Refund, "global", "", "ComputeSavingsPlans", "ComputeSP:3yrNoUpfront", "", "Discount", PricingTerm.reserved, "2021-01-01T00:00:00Z", "2021-02-01T00:00:00Z", "0", "-100.00", "No Upfront");
        line.setProductCode("ComputeSavingsPlans");
        line.setBillType(BillType.Refund);
        line.reservationARN = ""; // In this case the lineitem is flagged as reserved, but not given an arn
        ProcessTest test = new ProcessTest(line, Result.hourly, 30);
        Datum[] expected = {
            new Datum(CostType.refund, a2, Region.GLOBAL, null, productService.getProduct("ComputeSavingsPlans", "ComputeSavingsPlans"), Operation.getOperation(""), "ComputeSP:3yrNoUpfront", -100.0, 0.0),
        };
        test.run("2021-01-01T00:00:00Z", expected);                             
    }
    ...
    public void testTax() throws Exception {
        ...
        ProcessTest test = new ProcessTest(line, Result.hourly, 31);
        Datum[] expected = {
                new Datum(CostType.tax, a2, Region.US_EAST_1, null, ec2Product, Operation.getOperation("Tax - GST"), "HeavyUsage:c4.large", 7.44, 1),
            };
        ...
        expected = new Datum[]{
                new Datum(CostType.tax, a2, Region.US_EAST_1, null, ec2Product, Operation.getOperation("Tax - USSalesTax"), "HeavyUsage:c4.large", 4.37, 1),
            };
        test.run("2019-12-01T00:00:00Z", expected);
        ...
        test.setReportDate("2019-12-19T05:00:01Z");
        expected = new Datum[]{
                new Datum(CostType.tax, a2, Region.US_EAST_1, null, ec2Product, Operation.getOperation("Tax - USSalesTax"), "HeavyUsage:c4.large", 7.44, 1),
            };
        test.run("2019-12-01T00:00:00Z", expected);
    ...
    public void testTaxRefund() throws Exception {
        ...
        ProcessTest test = new ProcessTest(line, Result.hourly, 31);
        Datum[] expected = {
                new Datum(CostType.refundTax, a2, Region.US_EAST_1, null, ec2Product, Operation.getOperation("Tax - USSalesTax"), "NatGateway-Hours", -7.44, 1.0),
            };
        test.run("2021-01-01T00:00:00Z", expected);                
    }
